drop database if exists tarjetasdecredito;
create database tarjetasdecredito;
...
--Instancia de datos (20 clientes y 20 comercios)
insert into cliente values (1,'federico','gonzalez','matoso 4',1123455252);
...
insert into comercio values (1,'pollos hermanos','suprabon 1235','B4566',47411563); --mismo codigo postal que 1
...
insert into tarjeta values('7496323374756950',1,'202001','202507','236',50000,'vigente');
...
--Cierres
insert into cierre values(2022, 1, 0, '2022-01-01', '2022-02-01', '2022-02-05');
